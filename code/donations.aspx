...
<asp:Content ID="form_donate" ContentPlaceHolderID="content_area" Runat="Server">
    ...
    <asp:Panel runat="server" ID="pnl_uinfo" CssClass="donate-box">
        ...
        <%--In Memory Of--%>
        <asp:Label ID="lbl_mem" runat="server" Text="Label"  />
        ...
        <!--Province/ State -->
       <asp:Label ID="lbl_provstate" runat="server" Text="Prov/State" /><!-- Dependent on country -->
       <asp:DropDownList ID="ddl_provstate" runat="server" /><br /><br />
        <!-- This one will be a bit trickier, as it will be based on the selection made for country -->
        

        <!-- Postal Code/ZIP -->
            <asp:Label ID="lbl_postzip" runat="server" Text="PostalCode/ZIP" /><!-- dependent upon country -->
            <asp:TextBox ID="txt_postzip" runat="server" /><br /><br />
        ...
        <asp:Button ID="btn_uinext" runat="server" Text="Next" OnCommand="subNextClick" CommandName="UiNext"  />
    </asp:Panel>
    </ContentTemplate>
    <Triggers>
    ...
    <!-- Next Button -->
   <asp:Button ID="btn_creditnext" runat="server" Text="Next" OnCommand="subNextClick" CommandName="CreditNext"  />
